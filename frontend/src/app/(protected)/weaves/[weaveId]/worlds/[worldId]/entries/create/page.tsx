...
export default function CreateEntryPage() {
    ...
    const [selectedEntryType, setSelectedEntryType] = useState<{ id: string, name: string } | null>(null)
    ...
    const createMutation = useMutation({
        ...
        onSuccess: async (entry) => {
            ...
            queryClient.invalidateQueries({ queryKey: ["allEntries", weaveId, worldId] })
        ...
        onError: (error: any) => {
            toaster.create({
                ...
                description: error.message || "An error occurred while creating the entry.",
                type: "error",
            })
        },
    })
